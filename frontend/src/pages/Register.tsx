      ...
      <div className="w-full max-w-sm">
        <div className="bg-white dark:bg-stone-800 border border-warm-border dark:border-stone-700 rounded-2xl p-10 shadow-card">
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 w-full py-3 px-4 border border-stone-200 dark:border-stone-700 rounded-xl bg-white dark:bg-stone-800 text-stone-700 dark:text-stone-200 font-semibold text-sm hover:bg-stone-50 dark:hover:bg-stone-750 transition-all shadow-sm"
          >
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center">
              <span className="bg-white dark:bg-stone-800 px-3 text-xs text-stone-400 font-medium uppercase tracking-wider">or</span>
            </div>
          </div>
